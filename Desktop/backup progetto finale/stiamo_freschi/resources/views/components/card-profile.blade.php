<div class="cardLayout box">
    ...
    <div class="userCard">
        <div class="imageUser">
            <img src="{{ $userimageannouncement}}" alt="">
        </div>
        <div class="nomeUser">
    ...
    <div class="Areabutton">
        ...
        {{-- button show --}}
        <button class="btnCardLayoutProfileShow"><a style="color: white"
                href="{{ route('announcement.show', ['announcement' => $announcement]) }}">{{ __('ui.buttonDetails') }}</a></button>
        {{-- button edit --}}
        <a href="{{ route('announcement.edit', ['announcement' => $announcement]) }}" style="color: white"
            class="btnCardLayoutProfile1"><button class="btnCardLayoutProfile1">
        ...
        <form action="{{ route('announcement.destroy', ['announcement' => $announcement]) }}" method="post"
            class="btnCardLayoutProfile1">
            @csrf
            @method('DELETE')
            <button class="btnCardLayoutProfile1">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
